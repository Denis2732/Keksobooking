...
function render() {
  ...
  function renderPin() {
    ...
    pinElement.querySelector('img').setAttribute('name', [i]);
    ...
    pinElement.setAttribute('value', data[i].offer.type);
    pinElement.classList.add('map__rendering-pins');
  ...
  elem.addEventListener('click', event => {
    ...
    let pinBtn = event.target.getAttribute('name');

    let card = document.querySelectorAll('.map__card');
    card.forEach(element => {

      if (element.getAttribute('name') == pinBtn) {
